export const THE_GRAPH_URL = "https://api.thegraph.com/subgraphs/name/pokesi/tohu";
...
export const OHM_TICKER = "TOHU";
export const sOHM_TICKER = "sTOHU";
export const wsOHM_TICKER = "wsTOHU";
...
export const addresses: IAddresses = {
  250: {
    ...
    STAKING_ADDRESS: "0xCDdDeaCEeBBb887419F0355109581C967467bda4", // The new staking contract // OKAY
