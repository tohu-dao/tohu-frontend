              ...
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="h6">
                    <Trans>Connect your wallet to stake TOHU</Trans>
                  </Typography>
                </div>
              ) : (
                <>
                            ...
                            <Typography variant="body1" className="stake-note" color="textSecondary">
                              {view === 0 ? (
                                <>
                                  ...
                                  <br />
                                  <Trans>Please approve Tohu to use your</Trans> <b>{OHM_TICKER}</b>{" "}
                                ...
                                <>
                                  ...
                                  <br />
                                  <Trans>Please approve Tohu to use your</Trans> <b>{sOHM_TICKER}</b>{" "}
                  ...
                  <div className={`stake-user-data`}>
                    <StakeRow
                      ...
                      id="user-balance"
                      balance={`${trim(Number(ohmBalance), 4)} TOHU`}
                      {...{ isAppLoading }}
                    />
                    <Accordion className="stake-accordion" square>
                      ...
                      <AccordionDetails>
                        <StakeRow
                          ...
                          balance={`${trim(Number(sohmBalance), 4)} sTOHU`}
                          indented
                          {...{ isAppLoading }}
                        />
                        {/* <StakeRow
                        ...
                        <StakeRow
                          title={t`Wrapped Balance`}
                          balance={`${trim(Number(wsohmBalance), 4)} wsTOHU`}
                          {...{ isAppLoading }}
                          indented
                        />
                        {/* <StakeRow
